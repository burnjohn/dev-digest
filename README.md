...
| `mcp/`           | `@devdigest/mcp`            | Local stdio MCP server — five tools over HTTP to the API; started by an MCP client, not by `./scripts/dev.sh` ([README](mcp/README.md)) | —    |
