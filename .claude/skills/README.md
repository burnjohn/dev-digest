...
| [ui-architecture](ui-architecture/SKILL.md) | Frontend | UI architecture & code organization — component placement, feature-based structure, constants/utils/services/types boundaries, Next.js `app/` architecture |
