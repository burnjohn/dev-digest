...
ALTER TABLE "repos" ADD CONSTRAINT "repos_github_token_id_github_tokens_id_fk" FOREIGN KEY ("github_token_id") REFERENCES "public"."github_tokens"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
