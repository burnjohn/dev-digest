 ...
 *   GET    /pulls/:id/smart-diff                        → Smart Diff (files grouped by role,
 *                                                          deterministic, latest-review findings)
...
export default async function reviewsRoutes(appBase: FastifyInstance) {
  ...
  // ---- Smart Diff: pr_files grouped by role, annotated with the latest
  // review's findings. Deterministic (no LLM call) — see ./smart-diff/.
  app.get(
    '/pulls/:id/smart-diff',
