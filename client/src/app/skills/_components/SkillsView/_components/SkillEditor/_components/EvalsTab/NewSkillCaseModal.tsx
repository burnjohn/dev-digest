...
import { EXPECTATION_TYPES } from "@/components/eval-case-editor";
        ...
        <div style={s.formField}>
          ...
          {inputTab === "diff" ? (
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              ...
              />
              <div style={s.formField}>
                <label style={s.label} htmlFor="skill-new-case-files">
                  {t("caseEditorPanel.filesLabel")}
                </label>
                <TextInput id="skill-new-case-files" value={files} onChange={setFiles} mono />
              </div>
            </div>
          ) : (
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
